...
Runnable, type-checked documentation generated by [marklit](https://github.com/russwyte/marklit) — every code block is compiled against the real classpath, and example blocks are executed with their real output spliced in.

**[→ Browse the docs index](docs-generated/index.md)** (run `sbt docs/marklitGenerate` to regenerate)

| Topic | What's in it |
| --- | --- |
| [Getting started](docs-generated/getting-started.md) | Model → action → handler → conduit, end-to-end. |
| [Lenses and Optics](docs-generated/lenses-and-optics.md) | The `Optics` macro, `Lens` composition, lens laws. |
| [Handlers](docs-generated/handlers.md) | `update` / `updated`, `focus`, `>>` vs `++`, error handling, follow-up actions. |
| [Listeners](docs-generated/listeners.md) | `subscribe`, `Subscribe` ops, the `unsafe` API. |
| [FastEq](docs-generated/fast-equality.md) | Optional equality typeclass for skipping no-op notifications. |
| [Collection Lenses](docs-generated/collection-lenses.md) | `at` / `atVector` / `key` for `List` / `Vector` / `Map` element access. |
| [Iso, imap, xmap](docs-generated/iso.md) | Re-typing a lens through a bidirectional transformation. |

> **Doc generator note:** marklit is JVM-only, so the runnable docs build only on the JVM. The Conduit library itself cross-builds for **JVM, Scala.js, and Scala Native** without any change.
