...
Runnable, type-checked documentation generated by [marklit](https://github.com/russwyte/marklit) — every code block is compiled and executed against the real classpath.
